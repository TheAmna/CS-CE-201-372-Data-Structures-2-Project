...
3. Our professor really appreciated the project because we worked towards researching a new data structure not part of the course and tried simulating it for a real world application. We took inspiration from our professor, *[Sir Mobeen Movania's](https://github.com/mmmovania)* experience. He shared his work on mapping the coordinates for ships along the coastal areas of Pakistan using Binary Search Tree and Quad Tree. So we worked on *R tree* and tried implementing it for spatial queries along the longitudinal and latitudional areas of Pakistan.
